    ...
    >
      <div className="max-w-[1200px] mx-auto w-full flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Link
            to="/dashboard"
            className="bg-[#C8520A] hover:bg-[#A03E06] text-white px-5 py-2.5 rounded-lg text-sm font-bold transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg"
            style={{
              fontFamily: 'Syne, sans-serif',
              boxShadow: '0 4px 14px rgba(200,82,10,0.30)',
            }}
          >
            Dashboard →
          </Link>
      ...
      >
        <div className="px-7 py-10 flex flex-col gap-1">
          {navLinks.map((link, i) => (
              ...
              className="text-white text-2xl font-bold py-4 border-b border-white/8 flex items-center justify-between group"
              style={{
                fontFamily: 'Syne, sans-serif',
